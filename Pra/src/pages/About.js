        ...
        <div className="module bg-gradient-to-r from-blue-500 to-gray-700 rounded-lg p-8 text-white mb-8">
          ...
          <div className="features grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="feature bg-white rounded-lg p-4">
              ...
              <p style={{ color: 'black' }}>Assess various aspects of mental health, such as stress, anxiety, and depression, tailored to individual needs.</p>
            </div>
            <div className="feature bg-white rounded-lg p-4">
              <h3 className="text-xl font-bold mb-2">Professional Counseling</h3>
              <p style={{ color: 'black' }}>Schedule confidential counseling sessions with qualified professionals via video chat or in-person, ensuring personalized support.</p>
            </div>
            <div className="feature bg-white rounded-lg p-4">
              <h3 className="text-xl font-bold mb-2">Resource Library</h3>
              <p style={{ color: 'black' }}>Access a comprehensive library of articles, videos, and resources on mental health and well-being.</p>
            </div>
          </div>
        </div>
        ...
        <div className="module bg-gradient-to-r from-blue-500 to-gray-700 rounded-lg p-8 text-white">
          ...
          <div className="features grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="feature bg-white rounded-lg p-4">
              ...
              <p style={{ color: 'black' }}>Automatically transmit health records from hospitals to hostel wardens for prompt identification of sick students.</p>
            </div>
            <div className="feature bg-white rounded-lg p-4">
              <h3 className="text-xl font-bold mb-2">Proactive Health Management</h3>
              <p style={{ color: 'black' }}>Implement preventive measures, such as quarantine protocols and enhanced sanitation, to curb the spread of illnesses within the hostel community.</p>
            </div>
            <div className="feature bg-white rounded-lg p-4">
              <h3 className="text-xl font-bold mb-2">Emergency Response</h3>
              <p style={{ color: 'black' }}>Establish emergency response protocols and communication channels to address health crises effectively.</p>
            </div>
          </div>
        </div>
      </div>
